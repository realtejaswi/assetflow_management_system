...
const AssetTrackerPage = () => (
  <Box>
    ...
    <Typography color="text.secondary">Track stocks, mutual funds, gold, and fixed deposits — aggregated from Bank Simulator events.</Typography>
  </Box>
)
...
const LoanDashboardPage = () => (
  <Box>
    ...
    <Typography color="text.secondary">Outstanding loans and EMI schedules are aggregated from Bank Simulator events.</Typography>
  </Box>
)
    ...
    <QueryClientProvider client={queryClient}>
      <ThemeProvider theme={assetflowTheme}>
        ...
        <BrowserRouter>
          ...
          <Routes>
            <Route path="/" element={<AssetFlowLayout />}>
